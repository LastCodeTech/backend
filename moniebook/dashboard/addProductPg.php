...
<body class="bg-blue-100">
    ...
    <div class="flex justify-center items-center mt-15"><div>
        ...
        <form>
            ...
            <div class="flex justify-center mt-15"> <input type="submit" value="add product" class="bg-green-500 py-1 px-2 rounded-xl text-white capitalize hover:bg-green-600"></div>
