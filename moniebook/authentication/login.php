...
<body class=''>
    ...
    <h1 class="text font-bold text-2xl capitalize my-5 text-center">Login  with Moniepoint</h1>
    <h2 class='text-xl font-semi-bold text-center'>Login  with your Moniepoint details to continue</h2>
